...
#define STRING_SPLASH_LINE1 "v1.0.0" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "https://enumc.com"         // will be shown during bootup in line 2
...
// MAKE SURE TO CHANGE THIS https://github.com/MarlinFirmware/Marlin/wiki/LCD-Language
...
// DEPRECATED - #define DISABLE_MAX_ENDSTOPS
// DEPRECATED - #define DISABLE_MIN_ENDSTOPS
...
#define UBL_PROBE_PT_1_X       20//15
#define UBL_PROBE_PT_1_Y      160//180
#define UBL_PROBE_PT_2_X      20//15
#define UBL_PROBE_PT_2_Y      10//20
#define UBL_PROBE_PT_3_X      180//170
#define UBL_PROBE_PT_3_Y      10//20

// these are the offsets to the probe relative to the extruder tip (Hotend - Probe)
  #define X_PROBE_OFFSET_FROM_EXTRUDER     -34//-25
  #define Y_PROBE_OFFSET_FROM_EXTRUDER    -9//-29
  #define Z_PROBE_OFFSET_FROM_EXTRUDER    0//-12.35

  #define Z_HOMING_HEIGHT       5       // (in mm) Raise Z before homing (G28) for Probe Clearance.
                                              // Be sure you have this distance over your Z_MAX_POS in case

  #define XY_PROBE_SPEED          6000         // X and Y axis travel speed between probes, in mm/min

  // DEPRECATED - #define Z_RAISE_BEFORE_PROBING      5    //How much the extruder will be raised before traveling to the first probing point.
  // DEPRECATED - #define Z_RAISE_BETWEEN_PROBINGS      2  //How much the extruder will be raised when traveling from between next probing points
...
// DEPRECATED - #define HOMING_FEEDRATE				{100*60, 100*60, 2*60, 0}  // set the homing speeds (mm/min)
...
// DEPRECATED - #define DEFAULT_XYJERK                20.0    // (mm/sec)
...
#define PREHEAT_2_TEMP_BED 		85//100
