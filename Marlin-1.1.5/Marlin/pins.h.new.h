  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define BEEPER_PIN 33
      ...
      #define LCD_PINS_D7 		29
        ...
        #define SD_DETECT_PIN 49
      #else
        //arduino pin which triggers an piezzo BEEPER_PIN
        #define BEEPER_PIN 33  // BEEPER_PIN on AUX-4
      ...
      //arduino pin witch triggers an piezzo BEEPER_PIN
      #define BEEPER_PIN 33		//No BEEPER_PIN added
...
#define SUICIDE_PIN        -1  //PIN that has to be turned on right after start, to keep power flowing.
  ...
  #ifdef NEWPANEL
   //arduino pin which triggers an piezzo BEEPER_PIN
    #define BEEPER_PIN 79      // BEEPER_PIN on AUX-4
...
#define SD_DETECT_PIN 		13//-1	// Megatronics does not use this port
